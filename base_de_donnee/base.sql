...
ALTER TABLE COUR_EXERCICE 
  ADD FOREIGN KEY FK_COUR_EXERCICE_PROFESSEUR (ID_USER)
      REFERENCES PROFESSEUR (ID_USER) on delete cascade;
...
ALTER TABLE ENSEIGNE 
  ADD FOREIGN KEY FK_ENSEIGNE_PROFESSEUR (ID_USER)
      REFERENCES PROFESSEUR (ID_USER) ;
